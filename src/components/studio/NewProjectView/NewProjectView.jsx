...
export function NewProjectView() {
    const { studioMode, projectId } = useGenerationsStudioStore()
            ...
            <main className="flex-1 flex flex-col relative min-w-0 bg-[#080808] rounded-[2.5rem] border border-white/5 shadow-2xl overflow-hidden">
                ...
                <div className="absolute bottom-8 inset-x-0 z-30 flex justify-center px-6 pointer-events-none">
                    <div className="w-full max-w-[850px] pointer-events-auto">
                        <div className="">
                            {studioMode === "cinema" ? (
                                <GenerationsPromptBar hideBackground={true} isNewProject={true} />
                            ) : studioMode === "audio" ? (
                                <AudioPromptBar hideBackground={true} isNewProject={true} />
                            ) : (
