        ...
        >
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <DialogClose asChild>
                                <button className="p-1.5 rounded-md bg-white/5 hover:bg-white/10 text-white transition-all duration-300 border border-white/10 group backdrop-blur-md">
                    ...
                    <section className="flex flex-col gap-4">
                        ...
                        <div className="bg-white/5 rounded-xl border border-white/5 overflow-hidden">
                            <div 
                                ref={promptRef}
                                className={cn(
                                    "p-4 text-sm text-white/60 leading-relaxed break-words",
            ...
            <div className="p-6 pt-4 border-t border-white/5 bg-[#0F1113] grid grid-cols-5 gap-2">
                ...
                <button 
                    ...
                    className="button button-md button-secondary-reverted border-white/10 border hover:bg-white/10 transition-colors duration-200 h-12 col-span-3 flex items-center justify-center gap-2 text-white text-[12px] font-bold uppercase tracking-wider rounded-xl"
                >
                ...
                <DeleteGenerationDialog 
                    ...
                    itemName={item.asset?.asset_type || "generation"}
                >
                    <button 
