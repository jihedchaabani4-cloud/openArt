...
export function ProjectsPage() {
    const { projects, fetchProjects, createProject, deleteProject, updateProject, isLoading, error } = useProjectStore()
    ...
    return (
        <div className="min-h-screen bg-[#0c0c0c] text-white font-sans selection:bg-[#D4FF00]/30">
                        ...
                        <div className="flex items-center gap-6">
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-[#1a1c1e] border border-white/5 text-white/60 hover:text-white cursor-pointer transition-all group">
