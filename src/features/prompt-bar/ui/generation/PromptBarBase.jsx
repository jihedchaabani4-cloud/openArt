...
/**
 * PromptBarBase
 * Pure form wrapper — handles drag-and-drop overlay and form submission only.
...
function DragOverlay({ mode, selectedModel, onDrop, onDragLeave }) {
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 z-100 bg-[#0d0e0f]/90 backdrop-blur-sm flex items-center justify-center p-3 gap-3 rounded-xl"
